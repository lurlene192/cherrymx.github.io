...
<div class="wcm_msg">\
  ...
  onNewMessage: function(ev) {
    ...
    if (flags & 512 && (ev[7].attach1_type || ev[7].geo)) {
    ...
    for(var i in attachments) {
      ...
      switch(item.type) {
        ...
        case 'audio':
          ...
          res += '<a class="wcm_attach_item clear_fix wcm_attach_audio_item" href="https://vk.com/im?sel=-'+this.groupInfo.id+'&msgid='+msg_id+'" target="_blank">\
            <div class="wcm_attach_audio_ic fl_l"></div>\
            <div class="wcm_attach_audio_title">'+item.title+'</div>\
          </a>';
          break;
        case 'link':
          res += item.html;
